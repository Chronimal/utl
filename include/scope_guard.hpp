...
// Configure namespace preference for ScopeGuard.
// By default namespace utl is used.
#define SG_NAMESPACE_NAME utl

// clang-format off
#ifndef SG_BEGIN_NAMESPACE
#define SG_BEGIN_NAMESPACE namespace SG_NAMESPACE_NAME {
#endif // SG_BEGIN_NAMESPAC
#ifndef SG_END_NAMESPACE
#define SG_END_NAMESPACE }
#endif // SG_END_NAMESPACE

#ifndef SG_CONCATENATE_DETAIL
#define SG_CONCATENATE_DETAIL(l, r) l##r
#endif // SG_CONCATENATE_DETAIL

#ifndef SG_CONCATENATE
#define SG_CONCATENATE(sl, sr) SG_CONCATENATE_DETAIL(sl, sr)
#endif // SG_CONCATENATE

#ifndef SG_ANONYMOUS_VARIABLE
#ifdef __COUNTER__
#define SG_ANONYMOUS_VARIABLE(s) SG_CONCATENATE(s, __COUNTER__)
#else // __COUNTER___
#define SG_ANONYMOUS_VARIABLE(s) SG_CONCATENATE(s, __LINE__)
#endif // __COUNTER___
#endif // SG_ANONYMOUS_VARIABLE
// clang-format on
    ...
    class ScopeGuardImpl : public ScopeGuardImplBase
    {
      public:
        explicit ScopeGuardImpl(FunctionType& fn) noexcept(std::is_nothrow_copy_constructible<FunctionType>::value)
            : ScopeGuardImpl(asConst(fn), makeFailsafe(std::is_nothrow_copy_constructible<FunctionType>{}, &fn))
        {
        }
 ...
 * }
 *
 * Examine catch_scope_guard.cpp for some more sample usage.
 *
 * Stolen from:
 *   Facebook's folly
 ...
 *
 * Removed dependencies on folly:
 *   2020 by Chronimal
*      https://github.com/Chronimal
 */
template<typename F>
...
#define SCOPE_EXIT                                                                                                     \
    auto SG_ANONYMOUS_VARIABLE(SCOPE_EXIT_STATE) = ::SG_NAMESPACE_NAME::detail::ScopeGuardOnExit() + [&]() noexcept

#define SCOPE_FAIL                                                                                                     \
    auto SG_ANONYMOUS_VARIABLE(SCOPE_FAIL_STATE) = ::SG_NAMESPACE_NAME::detail::ScopeGuardOnFail() + [&]() noexcept

#define SCOPE_SUCCESS                                                                                                  \
    auto SG_ANONYMOUS_VARIABLE(SCOPE_SUCCESS_STATE) = ::SG_NAMESPACE_NAME::detail::ScopeGuardOnSuccess() + [&]()
